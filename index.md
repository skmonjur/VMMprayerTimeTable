...
<html>
   <body>
      <h1>Fajr: Pls see the link below for time</h1>
<h4><a href="http://awqat.live/">Awqat website link for Prayer Time</a></h4>
      ...
      <script>
         ...
         {
         document.getElementById("yy").innerHTML = "Duhur 1:45*";
         }
      </script>
	...
	<!-- <h1>Maghrib 6:08</h1> -->
      ...
      <!-- <h1>Maghrib 6:08</h1> -->
      <h1>Magrib & Eshaia - Pls follow awqat time table, link below</h1>
<h4><a href="http://awqat.live/">Awqat website link for Prayer Time</a></h4>
	  <!--h1>Eshaia: Check time on the</h1-->
