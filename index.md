...
<html>
   <body>
      ...
      <script>
         ...
         {
         document.getElementById("yy").innerHTML = "Duhur 1:30*";
         }
      </script>
	 ...
	 <h1>Maghrib (approximately) 7:<a id="magrib"></a></h1>
      <!-- <h1>Maghrib 6:08</h1> -->
      <h1>Isha 9:30*</h1>
	  <h4>* If Masjid whatsApp groups suggests a different time, please go with that one, this time table will be updated soon In Sha Allah</h4>
